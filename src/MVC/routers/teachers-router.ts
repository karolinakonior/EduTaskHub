...
const { getTeachers, getTeacherById, patchTeacherById, postTeacher, deleteTeacherById, getTeachersSubject, postTeachersSubject } = require("../controllers/TeachersController");
