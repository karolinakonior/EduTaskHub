...
const { getAssignments, postAssignment, getAssignmentById, patchAssignmentById, deleteAssignmentById, getFeedbackByAssignmentId } = require("../controllers/AssignmentsController");
...
exports.assignmentsRouter.route("/:assignment_id/feedback").get(getFeedbackByAssignmentId);
